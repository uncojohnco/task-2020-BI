...
class ResetCameraClipPlanesUI(MayaQWidgetDockableMixin, QWidget):
    ...
    def _init_ui_clip_edits(self):
        ...
        grp_box = QtWidgets.QGroupBox("Reset Values")

        form = QtWidgets.QFormLayout()
        form.setContentsMargins(1, 1, 1, 1)
        ...
        form.addRow("Near Clip Plane", near_edit)
        form.addRow("Far Clip Plane", far_edit)

        grp_box.setLayout(form)

        return near_edit, far_edit, grp_box
    ...
    def _init_ui(self):
        ...
        button_grp, options_grp_box = self._init_ui_camera_context_options()
        near_edit, far_edit, clip_edit_form = self._init_ui_clip_edits()
        ...
        main_layout.addWidget(clip_edit_form)
        main_layout.addWidget(options_grp_box)
